...
WAGTAIL_NEWSLETTER_CAMPAIGN_BACKEND = os.environ.get(
    "WAGTAIL_NEWSLETTER_CAMPAIGN_BACKEND", None
)
WAGTAIL_NEWSLETTER_LISTMONK_BASE_URL = os.environ.get(
    "WAGTAIL_NEWSLETTER_LISTMONK_BASE_URL"
)
WAGTAIL_NEWSLETTER_LISTMONK_USER = os.environ.get("WAGTAIL_NEWSLETTER_LISTMONK_USER")
WAGTAIL_NEWSLETTER_LISTMONK_API_KEY = os.environ.get(
